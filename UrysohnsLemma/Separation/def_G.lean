...
-- ANCHOR_END: G_Prop1_case_n1
  ...
  · -- n > 1
    ...
    have aux' : n ≠ 0 := Nat.ne_zero_of_lt hn
...
-- ANCHOR_END: G_Prop2_start
  ...
  have aux : n ≠ 0 := Nat.ne_zero_of_lt hn
  have aux' : n ≠ 1 := Ne.symm (Nat.ne_of_lt hn)
...
-- ANCHOR_END: G_Prop2_ext_sig
  ...
  · -- caso n > 0
    ...
    · -- caso n > 0, m = 0
      have cases : n = 1 ∨ n > 1 := Or.symm (Decidable.lt_or_eq_of_le' hn0)
    ...
    · -- caso n > 0, m > 0
      have cases : m = 1 ∨ m > 1 := Or.symm (Decidable.lt_or_eq_of_le' hm0)
