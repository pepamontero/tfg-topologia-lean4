...
\begin{proof}
  ...
  En realidad, esta condición se reduce a dos inecuaciones, que se pueden probar utilizando \bluecode{linarith} si se cuenta con la hipótesis \code{h$\delta : \delta \leq \delta1$}.
