...
constant n : nat
constant f : nat to nat
constant g : nat prod nat

Podemos utilizar entonces el comando \code{check} para ver que ocurre por detrás. 

También podemos declarar nuevos tipos y construcciones sobre tipos. Ejemplo:

constant X : Type
constant F : Type to Type (función que recibe un tipo y devuelve otro)


* Jerarquía de tipos. Necesario explicar?
