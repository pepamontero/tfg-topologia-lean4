...
Necesitaremos varias propiedades de estas funciones, que iremos enunciando según las vayamos necesitando. En particular, los resultados \code{r\_prop} y \code{s\_prop} son casi idénticos a utilizar \code{Classical.choose\_spec} sobre \code{exists\_r} y \code{exists\_s}.
