...
Además, cambiarles el nombre nos permite acceder fácilmente a sus definiciones antiguas, que almacenamos aquí:
...
\begin{lstlisting}
      ...
      rw [← G_def, ← g_def] at claim1 claim2 -- para usarlos con G y g
\end{lstlisting}
