...
También por esta propiedad, Lean no tiene un tipo especial para la implicación lógica: dadas dos proposiciones \code{p q : Prop}, una prueba de \code{p $\to$ q} es simplemente una función que, dada una prueba de \code{p}, devuelve una prueba de \code{q}. Esta identificación de una función con el conector implicación proviene de la correspondencia de Curry-Howard.
