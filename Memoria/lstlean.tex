...
% sorry
morekeywords=[2]{sorry},

% tactics, list taken from lean-syntax.el
morekeywords=[3]{
assumption,
apply, intro, intros, all_goals,
generalize, clear, revert, done, exact, exact?,
refine, repeat, cases, cases', rewrite, rw,
simp, simp_all, contradiction, exfalso,
constructor, ext, injection, specialize, swap,
induction, rfl, by_contra, use, left, right, trivial, linarith,
decreasing_by
},
...
{∨}{{\ensuremath{\vee}}}1
{¬}{{\ensuremath{\neg}}}1
{⊢}{{\color{tacticcolor}\ensuremath{\vdash}}}1
...
% numbers
%{0}{{\color{symbolcolor}0}}1
%{1}{{\color{symbolcolor}1}}1
%{2}{{\color{symbolcolor}2}}1
%{3}{{\color{symbolcolor}3}}1
%{4}{{\color{symbolcolor}4}}1
%{5}{{\color{symbolcolor}5}}1
%{6}{{\color{symbolcolor}6}}1
%{7}{{\color{symbolcolor}7}}1
%{8}{{\color{symbolcolor}8}}1
%{9}{{\color{symbolcolor}9}}1
,
...
keywordstyle=[1]{\ttfamily\color{tacticcolor}},

% Style for sorts
keywordstyle=[2]{\ttfamily\color{keywordcolor}},
